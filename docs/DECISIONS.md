...
resolution, and frozen baseline value, including the v0.4.1 likelihood-support repairs.

The app continues to delegate through root-public APIs and adds or copies no Wald, likelihood,
support-ratio, or support-interval formula. Its focused response, exports, interpretation,
privacy boundary, and scientific tolerances remain unchanged; exact pin, lock, staging,
